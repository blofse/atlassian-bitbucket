...
docker exec -i atlassian-bitbucket-database mysql -u bitbucket --password="$1" bitbucket < imports/bitbucket.sql
...
cp imports/bitbucket-mysql.properties bitbucket.properties
